...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------#
    classes_path    = r'VOCdevkit\VOC2007\voc_classes.txt'
    #-------------------------------------------------------#
    ...
    #   结果输出的文件夹，默认为map_out
    #-------------------------------------------------------#
    map_out_path    = 'map_out/{}'.format(cfg.map.cpk_dir)
    ...
    if map_mode == 0 or map_mode == 1:
        print("Load model.")
        modelUtil = ModelUtil(cfg, mode='map')
        ...
        for image_id in tqdm(image_ids):
            ...
            modelUtil.get_map_txt(image_id, image, map_out_path)
